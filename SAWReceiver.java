...
public class SAWReceiver {
    ...
    private void receiveFile(DatagramSocket socket) throws Exception {
        ...
        while (true) {
            ...
            } else if (dataPacket.getSeq() == expectedSeq) {
                applicationBuffer.write(payload);
                lastSeqRead = dataPacket.getSeq();
            } else {
                Log.writeLine("Sequência inesperada recebida: " + dataPacket.getSeq());
                continue;
            }
            ...
            ackPacket.setAckSeq(lastSeqRead);
            ...
            Log.writeLine("ACK enviado para seq=" + lastSeqRead);
